...
const services = [
  { title: "GoRide", description: "Location de motos électriques à autonomie illimitée.", image: motoHero, path: "/goride" },
              ...
              >
                <Link to={s.path} className="group block relative rounded-3xl overflow-hidden aspect-[3/4] md:aspect-[4/5]">
                  <motion.img
                    src={s.image}
                    alt={s.title}
                    className={`absolute inset-0 w-full h-full ${s.title === 'GoRide' ? 'object-contain bg-muted' : 'object-cover'}`}
                    loading="lazy"
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 md:p-7">
                    <div className="flex items-end justify-between gap-4">
                      <div className="flex-1">
                        <h3 className="font-display text-xl sm:text-2xl md:text-3xl font-bold text-primary-foreground mb-1.5 leading-tight">{s.title}</h3>
